...
<section style={{backgroundColor: "#143c2d"}} className="">
    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
        ...
        <p className="mb-8 text-lg font-normal text-white lg:text-xl sm:px-16 lg:px-48 dark:text-white">Answer a few questions and we’ll put you in touch with pros who can help</p>
